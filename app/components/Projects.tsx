...
// Memoized wrapper for ProjectCard3D to prevent unnecessary re-renders
const MemoizedProjectCard3D = memo(ProjectCard3D);
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 perspective-1000">
          {projects.map((project, index) => (
            <MemoizedProjectCard3D key={index} project={project} index={index} />
          ))}
        </div>
